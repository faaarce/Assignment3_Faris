//
//  SuccessCardViewController.swift
//  Exercise
//
//  Created by yoga arie on 19/07/24.
//

import UIKit
class SuccessCardViewController: UIViewController {
  ...
  lazy var notesLabel: UILabel = {
    let label = UILabel()
    label.text = "You placed the order successfully. You will get your food within \(foodsData?.duration) minutes. Thanks for using our services. Enjoy your food :)"
    label.textAlignment = .center
